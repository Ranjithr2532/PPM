...
export default function InspectionReport({ proposalId: propProposalId, submissionId: propSubmissionId, onClose, onBack }) {
    ...
    const performAutoSave = useCallback(async () => {
        ...
        try {
            ...
            console.error('Auto-save error in InspectionReport:', err);
            setAutoSaveState('error');
        } finally {
            isSavingRef.current = false;
        }
    }, [isReadOnly, reportNo, date, projectNo, type, drawingNo, drawingName, quantity, rows, preparedBy, approvedBy, docNo, docDate, selectedProposalId]);
